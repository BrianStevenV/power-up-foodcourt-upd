...
public interface IOrderRepository extends JpaRepository<OrderEntity, Long> {
    ...
    @Query(value = "SELECT * FROM orders o WHERE o.id = :id AND o.id_restaurant = :idRestaurant AND o.order_status_entity = 0", nativeQuery = true)
    OrderEntity findByIdAndIdRestaurantAndOrderStatus(@Param("id") Long id, @Param("idRestaurant")Long idRestaurant);
